...
public class Move extends SequentialCommandGroup {
  /** Creates a new Move. */
  public Move(ControlDrivetrain base, Intake intake, Arm arm, boolean isIntake, int mutiply) {
    ...
    addCommands(new RunCommand(() -> base.curvatureDrive(-0.2 * mutiply, 0, false, false), base).withTimeout(2.0));
